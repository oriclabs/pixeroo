...
function initWatermark() {
  ...
  if ($('wm-font-pill')) window._wmFontPill = new FontPill($('wm-font-pill'), { defaultFamily: 'Arial, sans-serif', defaultSize: 20, minSize: 10, maxSize: 200 });
...
function getWmOptions() {
  return {
    ...
    font: window._wmFontPill?.state.family || 'Arial, sans-serif',
